...
import ErbilCitadelTour from "../zainabsours/imges/ErbilCitadelTour.webp";
import HamrinMountainTrek from "../zainabsours/imges/HamrinMountainTrek.webp"; // أضف صورة هنا
import AncientBabylon from "../zainabsours/imges/AncientBabylon.webp"; // أضف صورة هنا
...
const Card = () => {
  ...
  const tours = [
    {
      title: "Erbil Citadel Tour",
      image: ErbilCitadelTour, // Replace this with an actual image of Erbil Citadel if available
    ...
    {
      title: "Hamrin Mountain Trek",
      image: HamrinMountainTrek, // Replace this with an actual image of Hamrin Mountains if available
      destination: "Hamrin Mountains",
      duration: "5 days",
      departureDates: "Spring and Fall",
      price: "$800",
      includes: "Guide, Hiking Gear, Meals",
    },
    {
      title: "Ancient Babylon",
      image: AncientBabylon, // Replace this with an actual image of Babylon if available
      destination: "Babylon, Hanging Gardens",
      duration: "3 days",
